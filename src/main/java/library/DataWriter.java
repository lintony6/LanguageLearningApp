...
public class DataWriter extends DataConstants{
  ...
  static void saveFriends(User user, JSONObject userJSON) {
  ...
  static void savePersonalData (User user, JSONObject userJSON) {
   ...
   */
  static Object getQuestionType(Object object) {
  ...
  static String getFileWritingPath(String filePath, String junitFilePath) {
    try {
      if(isJunitTest()) {
